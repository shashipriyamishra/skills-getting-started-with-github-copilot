...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team practices and interschool matches",
    ...
    "Drama Club": {
        "description": "Acting workshops, stage production, and rehearsals",
    ...
    "Science Club": {
        "description": "Hands-on experiments, guest speakers, and STEM projects",
